    ...
    <>
      ...
      <div style={{ width: "80vw", margin: "auto", marginTop: "20px" }}>
        <h1 style={{ textAlign: "center", margin: "20px 0px" }}>
          Disclaimer for TODOSLIST
        </h1>

        <p>
          If you require any more information or have any questions about our
          site's disclaimer, please feel free to contact us by email at
          pgramopadhye45@gmail.com. Our Disclaimer was generated with the help
          of the{" "}
        ...
        <h2>
          Disclaimers for https://condescending-pasteur-f1af07.netlify.app
        </h2>

        <p>
          All the information on this website -
          https://condescending-pasteur-f1af07.netlify.app - is published in
          good faith and for general information purpose and educational
          purpose. https://condescending-pasteur-f1af07.netlify.app does not
          ...
          on this website (https://condescending-pasteur-f1af07.netlify.app), is
          strictly at your own risk.
          https://condescending-pasteur-f1af07.netlify.app will not be liable
